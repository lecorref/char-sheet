...
export const Species: readonly ISpecies[] = [
	{
		...
		DefaultAttr: [{attr: EAttribute.Mind, name: "Mind", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Charisma, name: "Charisma", Vmax: 6, Vdefault: 2},
			{attr: EAttribute.Perception, name: "Perception", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Vigor, name: "Vigor", Vmax: 4, Vdefault: 2},
			{attr:EAttribute.Dexterity, name: "Dexterity", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Biotics, name: "Biotics", Vmax: 6, Vdefault: 2}]
	},
	{
		Id: 1,
		Name: "Humain",
		DefaultAttr: [{attr: EAttribute.Mind, name: "Mind", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Charisma, name: "Charisma", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Perception, name: "Perception", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Vigor, name: "Vigor", Vmax: 5, Vdefault: 2},
			{attr:EAttribute.Dexterity, name: "Dexterity", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Biotics, name: "Biotics", Vmax: 5, Vdefault: 0}],
	...
	},
	{
		...
		Name: "Krogan",
		DefaultAttr: [{attr: EAttribute.Mind, name: "Mind", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Charisma, name: "Charisma", Vmax: 4, Vdefault: 2},
			{attr: EAttribute.Perception, name: "Perception", Vmax: 6, Vdefault: 2},
			{attr: EAttribute.Vigor, name: "Vigor", Vmax: 7, Vdefault: 2},
			{attr:EAttribute.Dexterity, name: "Dexterity", Vmax: 5, Vdefault: 2},
			{attr: EAttribute.Biotics, name: "Biotics", Vmax: 5, Vdefault: 0}],
